      ...
      <div className="w-full max-w-md">
        <div className="bg-white rounded-2xl shadow-xl overflow-hidden">
          ...
          <div className="bg-gradient-to-r from-amber-700 to-orange-600 p-8 relative">
            ...
            <h2 className="mt-6 text-center text-3xl font-bold text-white">Welcome to BookCon</h2>
            <p className="mt-2 text-center text-amber-200">Sign in to discover your next great read</p>
          </div>
          ...
          <div className="p-8">
            ...
            <div className="mt-8">
              ...
              <div className="mt-6 bg-amber-50 p-4 rounded-lg border border-amber-100">
                ...
                <p className="text-xs text-right mt-1 text-gray-500">- George R.R. Martin</p>
              </div>
              ...
              <div className="mt-6 grid grid-cols-3 gap-3">
                ...
                >
                  <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 20 20">
                    <path d="M10 0C4.477 0 0 4.477 0 10c0 5.523 4.477 10 10 10s10-4.477 10-10c0-5.523-4.477-10-10-10zm0 18.75c-4.832 0-8.75-3.918-8.75-8.75S5.168 1.25 10 1.25 18.75 5.168 18.75 10 14.832 18.75 10 18.75zm4.688-11.513l-6.5 6.5-2.875-2.875.875-.875 2 2 5.625-5.625.875.875z" />
                  </svg>
                </button>
              </div>
            </div>
